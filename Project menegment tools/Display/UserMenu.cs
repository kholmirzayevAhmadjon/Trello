...
public class UserMenu
{
    ...
    public async void Create()
    {
       ...
       new TextPrompt<string>("Enter password :")
        ...
        try
        {
            ...
            AnsiConsole.Markup("[orange3] Registration completed successfully! kneel down. [/]\n");
            var table = new Table();
            ...
            table.AddRow(createdUser.Id.ToString(), createdUser.FirstName, createdUser.LastName, createdUser.Email, createdUser.Role.ToString());
    ...
    public async void GetByEmailPassvordAsyc()
    {
       ...
       new TextPrompt<string>("Enter password :")
        ...
        try
        {
            var circl = await _userService.GetByEmailPassword(email, password, role);
